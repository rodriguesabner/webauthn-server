...
let verifyAndroidKeyAttestation = (webAuthnResponse: any) => {
    ...
    let certPath = attestationStruct.attStmt.x5c.map((cert: any) => {
    ...
    let certJSON: any = asn1ObjectToJSON(certASN1);
    ...
    let AttestationExtensionJSON: any = asn1ObjectToJSON(AttestationExtension);
...
export default verifyAndroidKeyAttestation;
